  ...
  return (
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <Picker.Item label="TamilNadu" value="Tamil Nadu" />
      ...
      <Picker
        ...
        style={styles.input}
        enabled={cities.length > 0}  // Enable only if cities are available
      >
